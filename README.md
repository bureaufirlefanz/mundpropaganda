# Mundpropaganda — Design-Prototyp

Arbeitsprototyp für die neue Website. Zweck ist nicht die fertige Seite,
sondern das Ausbauen des Designs: Komponenten und Sections weiterentwickeln,
daraus neue Seitenlayouts zusammenstecken. Die Umsetzung erfolgt später in
Webflow — das Markup ist bewusst so gehalten, dass es sich dort nachbauen
lässt (semantisches HTML, CSS-Variablen, keine Framework-Abhängigkeit im
Markup).
...
| `npm run images` | `assets/raw/*` → responsive WebP/AVIF in `public/img/` |
...
public/img/          generierte Bildgrößen — nicht von Hand bearbeiten
...
gefüllt nur Bänder. Die verwendete Maske (`public/svg/tooth-silhouette.png`)
